...
export default async function TopicPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const response = await safeApiFetch<any>(`/comments/topic/${id}`)
  ...
  return <TopicThread topic={topic} replies={replies} backHref="/groups" backLabel="返回小组" composerTopicId={Number(id)} />
}