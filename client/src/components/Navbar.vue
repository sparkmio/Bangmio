<template>
  ...
  >
    ...
    <router-link
      to="/jump"
      :class="$route.path === '/jump' ? 'active text-primary' : 'text-base-content/40'"
      class="min-h-[44px]"
    >
      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          ...
          stroke-linejoin="round"
          stroke-width="2"
          d="M8 12h8m-4-4v8m-5.5-9h11A3.5 3.5 0 0 1 21 10.5v3a3.5 3.5 0 0 1-3.5 3.5l-2.2-2H8.7l-2.2 2A3.5 3.5 0 0 1 3 13.5v-3A3.5 3.5 0 0 1 6.5 7Z"
        />
      </svg>
      <span class="btm-nav-label text-xs">游戏</span>
    </router-link>
    <router-link
      to="/profile"
