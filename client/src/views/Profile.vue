        ...
        <div class="card-body p-8">
          <div class="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p class="text-sm text-base-content/50">@{{ profileUser?.username }} · UID: {{ profileUser?.id }}</p>
              <p v-if="profileUser?.sign" class="text-sm mt-1 text-base-content/60">{{ profileUser.sign }}</p>
              <div class="flex gap-3 mt-1.5">
                <span v-if="profileUser?.join_date" class="text-xs text-base-content/40">加入于 {{ profileUser.join_date }}</span>
                <span v-if="profileUser?.user_group" class="text-xs text-base-content/40">{{ profileUser.user_group }}</span>
              </div>
            </div>
          </div>
      ...
      <div class="card bg-base-100 border border-base-300">
        <div class="card-body p-8">
          <div class="flex items-center gap-3 mb-4">
            <h2 class="text-lg font-bold text-base-content">收藏</h2>
