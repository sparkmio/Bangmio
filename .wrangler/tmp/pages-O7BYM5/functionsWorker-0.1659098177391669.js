...
var init_utils = __esm({
  "C:/Users/\u5ED6\u96EA\u9F99/AppData/Roaming/npm/node_modules/wrangler/node_modules/unenv/dist/runtime/_internal/utils.mjs"() {
    init_functionsRoutes_0_2512626740919187();
      ...
      route(path, app6) {
        ...
        app6.routes.map((r) => {
          ...
          if (app6.errorHandler === errorHandler) {
            ...
            handler4 = /* @__PURE__ */ __name(async (c, next) => (await compose([], app6.errorHandler)(c, () => r.handler(c, next))).res, "handler");
...
var init_app = __esm({
  "../server/src/app.js"() {
    ...
    app5.route("/api/v1/user", user_default);
    app5.route("/api/v1/anime", anime_default);
    app5.route("/api/v1/collection", collection_default);
    app5.route("/api/v1/comments", comments_default);
    app5.get("/api/health", (c) => c.json({ status: "ok", country: c.env?.CF_IP_COUNTRY || "unknown" }));
    app_default = app5;
  }
});
...
// ../.wrangler/tmp/pages-O7BYM5/functionsRoutes-0.2512626740919187.mjs
var routes;
var init_functionsRoutes_0_2512626740919187 = __esm({
  "../.wrangler/tmp/pages-O7BYM5/functionsRoutes-0.2512626740919187.mjs"() {
    init_path();
    routes = [
      {
